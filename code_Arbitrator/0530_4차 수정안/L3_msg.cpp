...
{
    return (msg[L3_MSG_OFFSET_TYPE] == L3_MSG_TYPE_ANSWER);
}

int L3_checkIfdemandPdu(uint8_t* msg)
{
    return (msg[L3_MSG_OFFSET_TYPE] == L3_MSG_TYPE_DEMAND);
}
...
//edcode TOTAL SDU
uint8_t L3_MSG_encode_TOTAL(uint8_t* msg_data, uint8_t* data, int len)
{
